...
const PromptEditor = () => {
  ...
  const examplePrompt = "Hello, my name is ${name}. I am ${age} years old and I work as a ${job}. I live in ${city}.";
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex justify-between items-center mb-4">
              <label htmlFor="original-prompt" className="block text-lg font-semibold text-gray-900">
                System Prompt
              </label>
              <button
                onClick={resetPrompt}
            ...
            <p className="mt-2 text-sm text-gray-500">
              Enter your prompt with variables in the format: ${`{variableName}`}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="bg-gray-50 rounded-md p-4 min-h-[120px] border border-gray-200">
              <pre className="whitespace-pre-wrap text-sm text-gray-900 font-mono leading-relaxed">
                {generatedPrompt || (originalPrompt ? 'Enter values for variables to see the generated prompt...' : 'Enter a system prompt above to get started...')}
              </pre>
            </div>
          </div>
        </div>
